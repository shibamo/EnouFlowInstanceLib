...
namespace EnouFlowInstanceLib
{
  ...
  //错误的FlowActionRequest
  public class FlowActionRequestException : Exception
  {
    public FlowActionRequestException()
    {
    }

    public FlowActionRequestException(string message)
        : base(message)
    {
    }

    public FlowActionRequestException(string message, Exception inner)
        : base(message, inner)
    {
    }
  }
